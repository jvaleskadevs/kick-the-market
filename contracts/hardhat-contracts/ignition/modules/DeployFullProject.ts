...
export default buildModule("DeployFullProjectModule", (m) => {
  ...
  m.call(jackpot, "grantRole", [JACKPOT_GAME_ROLE, ktmFree], { id: "JackpotGrantRoleFreeBase_"});
  m.call(jackpot, "grantRole", [JACKPOT_GAME_ROLE, ktmPaid], { id: "JackpotGrantRolePaidBase_"});
